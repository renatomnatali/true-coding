...
export function WorkspacePanel({
  ...
  switch (status) {
    ...
    case 'FAILED':
      return <FailedWorkspace projectId={projectId} projectName={projectName} repoUrl={repoUrl} />
    case 'LIVE':
        ...
        {!resumeConfirmed ? (
          <div className="mx-auto max-w-3xl rounded-xl border border-amber-200 bg-amber-50 p-6">
            ...
            <p className="mb-4 text-sm text-amber-800">
              Este projeto estava em geração quando você saiu. Confirme para retomar a operação.
            </p>
            <div className="flex flex-wrap gap-3">
              <button
          ...
          <div className="mx-auto max-w-3xl">
            <GenerationProgress projectId={projectId} autoStart />
          </div>
        )}
      </div>
    )
...
function FailedWorkspace({
  ...
  if (!FEATURES.AUTONOMOUS_DEVELOPMENT_V1) {
    return (
      <div className="h-full overflow-y-auto bg-gray-50 p-6">
        <div className="mx-auto max-w-3xl">
          <GenerationProgress projectId={projectId} autoStart={false} />
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="flex h-full items-center justify-center p-6">
      <div className="max-w-md rounded-xl border border-red-200 bg-red-50 p-6 text-center">
        <h2 className="mb-2 text-xl font-bold text-red-900">Falha na execucao</h2>
        <p className="mb-4 text-sm text-red-800">
          O pipeline autonomo do projeto {projectName} encontrou erro.
          Veja os detalhes no painel de atividade e use checkpoint/retry.
        </p>
        {repoUrl && (
          <a
            href={repoUrl}
            ...
            className="inline-flex items-center justify-center rounded-lg border border-red-300 bg-white px-4 py-2 text-sm font-medium text-red-900 hover:bg-red-100"
          >
            Ver repositorio
          </a>
        )}
...
function LiveWorkspace({
  ...
  return (
    <div className="h-full overflow-y-auto p-6">
      <div className="mx-auto max-w-3xl space-y-6">
        {/* Success Banner */}
        <div className="rounded-xl border-2 border-emerald-400 bg-gradient-to-br from-emerald-50 to-blue-50 p-8 text-center">
          <div className="mb-3 text-5xl">🚀</div>
          <h2 className="mb-2 text-2xl font-bold text-slate-900">
            Seu App Está Online!
          </h2>
          <p className="mb-5 text-sm text-slate-600">
            Deploy concluído com sucesso • Build otimizado • CDN global ativo
          </p>
          {deployUrl && (
            <a
              href={deployUrl}
        ...
        <div className="rounded-lg border bg-white p-5">
          <h3 className="mb-4 text-sm font-semibold text-slate-900">🌐 Informações do Site</h3>

          {deployUrl && (
            <div className="mb-4">
              <div className="mb-1 text-xs font-medium uppercase text-slate-500">URL do Site</div>
              <div className="flex items-center gap-2">
                <a
                  href={deployUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 rounded bg-slate-100 px-3 py-2 text-sm font-medium text-blue-600 hover:underline"
                >
                  {deployUrl}
                </a>
                <button
          ...
          <div className="mb-4">
            <div className="mb-1 text-xs font-medium uppercase text-slate-500">Status</div>
            <span className="inline-flex items-center gap-2 rounded bg-emerald-100 px-3 py-1.5 text-sm font-semibold text-emerald-700">
          ...
          {repoUrl && (
            <div>
              <div className="mb-1 text-xs font-medium uppercase text-slate-500">Repositório</div>
              <a
                href={repoUrl}
                target="_blank"
                rel="noopener noreferrer"
        ...
        {/* Performance Stats */}
        <div className="rounded-lg border bg-white p-5">
          <h3 className="mb-4 text-sm font-semibold text-slate-900">⚡ Performance</h3>
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-2xl font-bold text-emerald-600">98</div>
              <div className="text-xs uppercase text-slate-500">Lighthouse</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-blue-600">1.2s</div>
              <div className="text-xs uppercase text-slate-500">First Load</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-amber-600">89KB</div>
              <div className="text-xs uppercase text-slate-500">Bundle</div>
            </div>
          </div>
        </div>
      </div>
